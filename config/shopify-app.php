...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Addify Storewide sale'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_orders,write_orders,read_discounts,write_discounts'),
